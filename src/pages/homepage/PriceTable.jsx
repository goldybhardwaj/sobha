...
function PriceTable() {
  ...
  return (
    <div>
      <div className=" text-center mt-5 lg:mt-4 md:mt-8 sm:mt-8 mb-1 lg:mb-4 md:mb-2 sm:mb-1 ">
        <h2
          className={`${styles.color} text-normal px-3 lg:px-0 md:px-2 sm:px-3 lg:text-3xl md:text-3xl sm:text-2xl ${styles.font} `}
        >
                ...
                <table className="w-full border-collapse shadow-lg rounded-lg text-xs sm:text-sm md:text-base bg-white">
                  <thead>
                    <tr className="text-gray-700 bg-gray-100">
                      <th className="py-2 px-2 sm:py-3 sm:px-4 text-left font-semibold whitespace-nowrap">
                        Type
                      </th>
                      <th className="py-2 px-2 sm:py-3 sm:px-4 text-left font-semibold whitespace-nowrap">
                        Saleable Area
                    ...
                    <tr className="border-b hover:bg-gray-50">
                      ...
                      <td className="py-2 px-2 sm:py-3 sm:px-4">
                        <button
                          ...
                          className={`${styles.priceButton} py-1.5 px-3 sm:py-2 sm:px-4 text-xs sm:text-sm rounded-lg transition-colors duration-200 whitespace-nowrap cursor-pointer`}
                        >
