            ...
            <tbody>
              <tr className="border-b hover:bg-gray-50">
                ...
                <td className="py-2 px-2 sm:py-3 sm:px-4">
                  <button className="py-1.5 px-3 sm:py-2 sm:px-4 text-xs sm:text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 whitespace-nowrap">
